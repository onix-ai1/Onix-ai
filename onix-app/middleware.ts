...
const PROTECTED = ['/dashboard', '/pipeline', '/calculator', '/valuation', '/investors', '/outreach', '/listings', '/copilot', '/workspace', '/profile', '/onboarding'];
...
export const config = {
  matcher: [
    '/dashboard/:path*', '/pipeline/:path*', '/calculator/:path*', '/valuation/:path*', '/investors/:path*',
    '/outreach/:path*', '/listings/:path*', '/copilot/:path*',
